...
export default class ThemeApis {
    ...
    public listThemes() {
        ...
        // 过滤出主题扩展
        const themeExtensions = extensions.filter(ext => {
        ...
        return JSON.stringify(themeInfos);
    }

    public applyTheme(themeId: string, uiTheme: string) {
